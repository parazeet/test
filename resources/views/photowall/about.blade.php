...
<head>
    ...
    <!-- Custom-Files -->
    <link rel="stylesheet" href="photowall/css/bootstrap.css">
    <!-- Banner-Slider-CSS -->
    <link rel="stylesheet" href="photowall/css/banner-style.css">
    <link rel="stylesheet" href="photowall/css/aos.css">
    <link href='photowall/css/aos-animation.css' rel='stylesheet prefetch' type="text/css" media="all" />
    <!-- owl carousel -->
    <link rel="stylesheet" href="photowall/css/style.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <link rel="stylesheet" href="photowall/css/fontawesome-all.css">
...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('team')}}">Photographers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('pricing')}}">Pricing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('clients')}}">Testimonials</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="inner-sec-w3ls py-lg-5 py-3">
                ...
                <div class="row">
                    <div class="col-lg-6 about-img" data-aos="flip-right">
                        <img class="img-fluid" src="photowall/images/ab.jpg" alt="">
                    </div>
                    <div class="col-lg-6 about-right mt-lg-4" data-aos="flip-left">
                        ...
                        <ul class="author d-flex">
                            <li><img class="img-fluid" src="photowall/images/author.jpg" alt=""></li>
    ...
    <script src="photowall/js/jquery-2.2.3.min.js"></script>
    <script src='photowall/js/aos.js'></script>
    <script>
        AOS.init({
   ...
   <!--/ start-smoth-scrolling -->
    <script src="photowall/js/move-top.js"></script>
    <script src="photowall/js/easing.js"></script>
    <script>
    ...
    <script src="photowall/js/bootstrap.js"></script>
